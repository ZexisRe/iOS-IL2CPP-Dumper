...
**Tags:** `#ios` `#jailbreak` `#jailbroken` `#trollstore` `#il2cpp` `#il2cppdumper` `#iosdumper` `#iosil2cppdumper` `#unity` `#unity3d` `#dumpcs` `#dump` `#ipa` `#decrypt` `#decryption` `#reverseengineering` `#iosre` `#mobile` `#unitygames` `#globalmetadata`
